...
optionProcessor.command('forEffective')
  ...
  .option('--stringify-anno-xpr <val>', { valid: [ 'true', 'false' ] } )
  ...
  Options
   -h, --help                            Show this help text
       ...
       --stringify-anno-xpr <val>        Stringify annotation expressions:
                                          true:           convert annotation expression nodes to CDL-like strings
                                          false:(default) keep annotation expressions as structured CSN objects
