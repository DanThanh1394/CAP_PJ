...
module.exports = {
  ...
  for: {
    ...
    effective: (options) => {
      ...
      const defaultOptions = {
        sqlMapping: 'plain', resolveSimpleTypes: true, resolveProjections: true, stringifyAnnoXpr: false, remapOdataAnnotations: false, keepLocalized: false,
      };
    ...
    seal: (options) => {
      ...
      const defaultOptions = { stringifyAnnoXpr: false, remapOdataAnnotations: true, deriveAnalyticalAnnotations: false };
