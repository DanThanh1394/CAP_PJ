...
declare namespace compiler {
  ...
  export interface EffectiveCsnOptions extends SqlOptions {
    ...
    /**
     * If true, stringify annotation expression nodes as CDL-like text.
     *
     * Only expression-shaped nodes are stringified. Other annotation values stay unchanged.
     *
     * @default false
     */
    stringifyAnnoXpr?: boolean
    /**
